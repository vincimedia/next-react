...
import {alpha, Box, Button, Grid, Skeleton, Stack, Typography, useMediaQuery,} from "@mui/material";
                ...
                <Grid container spacing={2}>
                  {filteredData?.map((item, i) => (
                    <Grid item xs={6} md={3} key={item?.id}>
                      <CustomBrandCard>
                        <BrandCard baseUrl={baseUrl} {...item} />
                      </CustomBrandCard>
                    </Grid>
                  ))}
                </Grid>
...
const CustomWrapperStack = styled(Stack)(({ theme }) => ({
  width: "575px",
  flexGrow: "1",
  borderRadius: "5px",
  position: "relative",
